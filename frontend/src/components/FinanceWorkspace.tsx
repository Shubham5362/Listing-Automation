...
const initialTransactions: FinanceTransaction[] = [
  {
    ...
    orderId: '-',
    amount: 124350,
    amountDisplay: '₹1,24,350',
    isNegative: false,
    status: 'Completed',
    marketplace: 'Amazon',
    settlementId: 'SETT-2024-015',
  ...
  },
  {
    ...
    date: 'Dec 09, 2024',
    type: 'Payout',
    description: 'Flipkart Settlement',
    orderId: '-',
    amount: 98420,
    amountDisplay: '₹98,420',
    isNegative: false,
    status: 'Completed',
    marketplace: 'Flipkart',
    settlementId: 'SETT-2024-014',
    utrNumber: 'AXIS9876543210',
    processedDate: 'Dec 09, 2024, 02:15 PM',
  },
];
