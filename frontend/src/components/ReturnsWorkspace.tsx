...
// 10 initial records matching the reference screenshot in high definition
const initialReturnsData: ReturnRecord[] = [
  {
    id: 1,
    returnId: 'RET-2024-001',
    orderId: '#408-1234567',
    orderDisplayId: '408-1234567',
    marketplace: 'Amazon',
    product: {
    ...
    status: 'Pending',
    requestedOn: 'Dec 15, 2024',
    requestedOnFull: 'Dec 15, 2024, 10:24 AM',
  ...
  },
  {
    ...
    status: 'Approved',
    requestedOn: 'Dec 14, 2024',
    requestedOnFull: 'Dec 14, 2024, 02:45 PM',
    returnWindow: 'Within policy',
    refundAmount: 599,
  },
  {
    ...
    status: 'Refunded',
    requestedOn: 'Dec 14, 2024',
    requestedOnFull: 'Dec 14, 2024, 11:10 AM',
    returnWindow: 'Within policy',
    refundAmount: 699,
  },
  {
    ...
    status: 'Replacement',
    requestedOn: 'Dec 13, 2024',
    requestedOnFull: 'Dec 13, 2024, 04:30 PM',
    returnWindow: 'Within policy',
    refundAmount: 349,
  },
  {
    ...
    status: 'Pending',
    requestedOn: 'Dec 13, 2024',
    requestedOnFull: 'Dec 13, 2024, 09:15 AM',
    returnWindow: 'Within policy',
    refundAmount: 299,
  },
  {
    ...
    status: 'Approved',
    requestedOn: 'Dec 12, 2024',
    requestedOnFull: 'Dec 12, 2024, 01:20 PM',
    returnWindow: 'Within policy',
    refundAmount: 449,
  },
  {
    ...
    status: 'Rejected',
    requestedOn: 'Dec 12, 2024',
    requestedOnFull: 'Dec 12, 2024, 06:10 PM',
    returnWindow: 'Within policy',
    refundAmount: 899,
  },
  {
    ...
    reason: 'Changed my mind',
    status: 'Refunded',
    requestedOn: 'Dec 11, 2024',
    requestedOnFull: 'Dec 11, 2024, 11:40 AM',
    returnWindow: 'Within policy',
    refundAmount: 649,
  },
  {
    id: 9,
    returnId: 'RET-2024-009',
    orderId: '#408-7531590',
    orderDisplayId: '408-7531590',
    marketplace: 'Flipkart',
    product: {
    ...
    status: 'Replacement',
    requestedOn: 'Dec 11, 2024',
    requestedOnFull: 'Dec 11, 2024, 03:25 PM',
    returnWindow: 'Within policy',
    refundAmount: 999,
  },
  {
    id: 10,
    returnId: 'RET-2024-010',
    orderId: '#OD95175328',
    orderDisplayId: 'OD95175328',
    marketplace: 'Flipkart',
    product: {
    ...
    status: 'Pending',
    requestedOn: 'Dec 10, 2024',
    requestedOnFull: 'Dec 10, 2024, 10:05 AM',
    returnWindow: 'Within policy',
    refundAmount: 249,
  },
];
