...
const defaultProductCatalog: ProductCatalogItem[] = [
  ...
  },
  {
    ...
    listingStatus: 'Active',
    asin: 'B09X8Y7Z1D',
    flipkartFsn: 'BOTG99XYZD',
    growthMetrics: {
      revenueGrowth: 11.2,
      unitsSold: 80,
      unitsSoldGrowth: 14.3,
      averagePrice: 349,
      marginGrowth: 1.2,
    },
  },
  ...
  },
  {
    ...
    listingStatus: 'Active',
    asin: 'B09X8Y7Z1G',
    flipkartFsn: 'COPG99XYZG',
    growthMetrics: {
      revenueGrowth: 18.5,
      unitsSold: 28,
      unitsSoldGrowth: 15.0,
      averagePrice: 899,
      marginGrowth: 3.4,
    },
  },
