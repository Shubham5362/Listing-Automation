...
from app.api.universal_product import router as universal_product_router
from app.api.marketplace_adapters import router as marketplace_adapters_router
from app.api.marketplace_form_knowledge import router as marketplace_form_knowledge_router
from app.api.master_listing import router as master_listing_router
...
from app.api.browser_execution import router as browser_execution_router
...
from app.api.inventory_price_automation import router as inventory_price_automation_router
...
from app.api.unified_orders import router as unified_orders_router
from app.api.shipping_fulfillment import router as shipping_fulfillment_router
...
from app.api.seller_intelligence_snapshot import router as seller_intelligence_snapshot_router
from app.api.marketplace_certification import router as marketplace_certification_router
...
for router in [auth_router, accounts_router, jobs_router, actions_router, marketplaces_router, personal_marketplaces_router, personal_ai_seller_agent_router, personal_finance_router, personal_listing_automation_router, universal_product_router, product_knowledge_router, marketplace_adapters_router, marketplace_form_knowledge_router, master_listing_router, marketplace_catalog_router, marketplace_changes_router, marketplace_expansion_router, autofill_router, browser_execution_router, shipping_fulfillment_router, marketplace_operations_router, listing_operations_router, catalog_router, catalog_intelligence_router, media_router, ai_listing_router, listing_intelligence_router, diagnostics_router, vision_router, listing_validation_router, learning_router, autonomous_router, autonomous_execution_router, predictive_intelligence_router, production_router, reliability_router, final_ai_seller_os_router, seller_os_v2_router, release_readiness_router, advanced_business_intelligence_router, inventory_router, inventory_price_automation_router, inventory_intelligence_router, orders_router, unified_orders_router, order_ops_router, pricing_router, returns_router, finance_router, finance_intelligence_router, advertising_router, advertising_ai_router, seller_intelligence_router, seller_intelligence_snapshot_router, marketplace_certification_router, dashboard_router, advanced_analytics_router, business_intelligence_router, growth_opportunities_router, strategy_action_planner_router, operations_autopilot_router, operations_workspace_router, operations_control_router, seller_operations_router, ai_seller_agent_router, agents_router, automation_router, notifications_router, monitoring_router, ai_command_router, realtime_router, ui_compat_router]:
