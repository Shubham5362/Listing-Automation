...
api_router.include_router(auth_router); api_router.include_router(accounts_router); api_router.include_router(jobs_router); api_router.include_router(actions_router); api_router.include_router(marketplaces_router); api_router.include_router(personal_marketplaces_router); api_router.include_router(personal_ai_seller_agent_router); api_router.include_router(personal_finance_router); api_router.include_router(personal_listing_automation_router); api_router.include_router(product_knowledge_router); api_router.include_router(marketplace_adapters_router); api_router.include_router(marketplace_changes_router); api_router.include_router(autofill_router); api_router.include_router(marketplace_operations_router); api_router.include_router(listing_operations_router); api_router.include_router(catalog_router); api_router.include_router(catalog_intelligence_router); api_router.include_router(media_router); api_router.include_router(ai_listing_router); api_router.include_router(listing_intelligence_router); api_router.include_router(inventory_router); api_router.include_router(inventory_intelligence_router); api_router.include_router(orders_router); api_router.include_router(order_ops_router); api_router.include_router(pricing_router); api_router.include_router(returns_router); api_router.include_router(finance_router); api_router.include_router(finance_intelligence_router); api_router.include_router(advertising_router); api_router.include_router(advertising_ai_router); api_router.include_router(seller_intelligence_router); api_router.include_router(dashboard_router); api_router.include_router(advanced_analytics_router); api_router.include_router(business_intelligence_router); api_router.include_router(growth_opportunities_router); api_router.include_router(strategy_action_planner_router); api_router.include_router(operations_autopilot_router); api_router.include_router(operations_workspace_router); api_router.include_router(operations_control_router); api_router.include_router(ai_seller_agent_router); api_router.include_router(agents_router); api_router.include_router(automation_router); api_router.include_router(notifications_router); api_router.include_router(monitoring_router); api_router.include_router(ai_command_router); api_router.include_router(realtime_router); api_router.include_router(ui_compat_router)
