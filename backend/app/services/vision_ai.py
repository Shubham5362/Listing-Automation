...
def analyze_image(url: str) -> dict[str, object]:
    ...
    blur = float(edge_stat.stddev[0] ** 2)
    ...
    return {
        ...
        "findings": findings,
        "attributes": {"orientation": "portrait" if height > width else "landscape" if width > height else "square"},
        "confidence": 90 if not findings else 78,
